...
1. `Express` module to create a server that provides the REST API's.
2. `MondoDB` NoSQL database, using the native `Node.js` driver.
3. `Mongoose` to:
...
3. `bcrypt` library to store passwords securely by hashing them. 
